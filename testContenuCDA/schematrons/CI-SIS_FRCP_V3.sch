...
<!-- 
    ...
    15/10/19 : NMA : MAJ des noms de schématrons et variables
-->
<schema xmlns="http://purl.oclc.org/dsdl/schematron"
    xmlns:cda="urn:hl7-org:v3" queryBinding="xslt2"
    xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" schemaVersion="CI-SIS_FRCP_V3.sch">
    <title>Rapport de conformité du document aux spécifications du volet Fiche RCP V3</title>
    ...
    <pattern id="variables">
        ...
        <rule context='*[cda:templateId/@root="1.2.250.1.213.1.1.1.8"]'>
            ...
            <assert test='.//cda:templateId[@root = "1.2.250.1.213.1.1.2.33"]'>
                [CI-SIS_FRCP] : Erreur de conformité au volet : La section "Statut du dossier présenté à la RCP" doit être présente dans le document.
            </assert> 
