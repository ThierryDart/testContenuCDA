...
-->
<schema xmlns="http://purl.oclc.org/dsdl/schematron" defaultPhase="modeles_de_contenuCDA"
    xmlns:cda="urn:hl7-org:v3" queryBinding="xslt2" xmlns:lab="urn:oid:1.3.6.1.4.1.19376.1.3.2"
    xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" schemaVersion="ModelesDeContenuCDA.sch">
    ...
    <!-- Entrées relatives à modèles de contenu CDA -->
    ...
    <include href="../include/entrees/E_familyHistoryOrganizer_fr.sch"/>
    ...
    <include href="../include/entrees/ER_problemStatusObservation_fr.sch"/>
    <include href="../include/entrees/ER_severity_fr.sch"/>
    ...
    <phase id="modeles_de_contenuCDA">
        ...
        <active pattern="E_familyHistoryOrganizer_fr"/>
        ...
        <active pattern="E_vtalSignsObservation_fr"/>
        <active pattern="ER_problemStatusObservation_fr"/>
        <active pattern="ER_severity_fr"/>
    </phase>
</schema>
