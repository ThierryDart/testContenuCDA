...
<!--                  -=<<o#%@O[ E_AllergiesAndIntolerances_UFCV.sch ]O@%#o>>=-
...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="E_AllergiesAndIntolerances_UFCV">
    ...
    <rule context='*[cda:templateId/@root = "1.3.6.1.4.1.19376.1.5.3.1.4.6"]'>
        ...
        <assert test='cda:participant/@typeCode = "CSM"'>
            [E_AllergiesAndIntolerances_UFCV] Erreur de Conformité CI-SIS: L'allergène
        ...
        <assert
            ...
            [E_AllergiesAndIntolerances_UFCV] Erreur de Conformité CI-SIS: Le médicament responsable de la réaction observée doit
        ...
        <assert
            test='not(cda:code[@code = "DNAINT"]) or ((cda:value/@code = "D0070-1") or (cda:value/@code = "D0070-2"))'>
            [E_AllergiesAndIntolerances_UFCV] Erreur de Conformité CI-SIS: Les effets d'augmentation ou de diminution de l'INR
