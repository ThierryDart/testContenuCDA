...
<!--                  -=<<o#%@O[ E_DefribrillateurOrg_UFCV.sch ]O@%#o>>=-
...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="E_DefribrillateurOrg_UFCV">
    ...
    <rule
        ...
        <assert test='cda:code[@code = "D0001-1"]'>
            [E_DefribrillateurOrg_UFCV] Erreur de Conformité CI-SIS: Le code de
        ...
        <assert test='cda:code[@codeSystem = "1.2.250.1.213.1.1.4.2"]'> Erreur de Conformité CI-SIS:
            [E_DefribrillateurOrg_UFCV] L'élément 'codeSystem' de l'organizer 'Défibrillateur' doit être codé dans dans le
        ...
        <assert test='.//cda:templateId[@root = "1.2.250.1.213.1.1.3.1"]'>
            [E_DefribrillateurOrg_UFCV] Erreur de Conformité PCC: L'élément 'Défibrillateur' doit au moins contenir une entrée 'Observation
        ...
        <assert
            ...
            [E_DefribrillateurOrg_UFCV] Erreur de Conformité CI-SIS: La date d'implantation du matériel est un élément
        ...
        <assert
            ...
            [E_DefribrillateurOrg_UFCV] Erreur de Conformité CI-SIS: Le Type de matériel implanté est un élément obligatoire
        ...
        <assert
            ...
            [E_DefribrillateurOrg_UFCV] Erreur de Conformité CI-SIS: La Localisation de l'implant est un élément obligatoire
            de l'organizer. </assert>
        <!-- Marque de l'implant -->
        <assert
            test='cda:component/cda:observation[cda:templateId/@root = "1.2.250.1.213.1.1.3.1"]/cda:code/@code = "L0057"'>
            [E_DefribrillateurOrg_UFCV] Erreur de Conformité CI-SIS: La marque de l'implant est l'un des éléments obligatoires
        ...
        <assert
            ...
            [E_DefribrillateurOrg_UFCV] Erreur de Conformité CI-SIS: Le modèle de l'implant est un élément obligatoire de
            l'organizer. </assert>
        <!-- Numéro de série -->
        <assert
            test='cda:component/cda:observation[cda:templateId/@root = "1.2.250.1.213.1.1.3.1"]/cda:code/@code = "L0059"'>
            [E_DefribrillateurOrg_UFCV] Erreur de Conformité CI-SIS: Le numéro de série de l'implant est un élément
            obligatoire de l'organizer. </assert>
        <!-- Tension de la pile à ERI -->
        <assert
            test='cda:component/cda:observation[cda:templateId/@root = "1.2.250.1.213.1.1.3.1"]/cda:code/@code = "L0001"'>
            [E_DefribrillateurOrg_UFCV] Erreur de Conformité CI-SIS: La tension de la pile à ERI est l'un des éléments
        ...
        <assert
            ...
            [E_DefribrillateurOrg_UFCV] Erreur de Conformité CI-SIS: L'IRE est un élément obligatoire de l'organizer. </assert>
        <!-- Type défibrillateur -->
        <assert
            test='cda:component/cda:observation[cda:templateId/@root = "1.2.250.1.213.1.1.3.1"]/cda:code/@code = "L0004"'>
            [E_DefribrillateurOrg_UFCV] Erreur de Conformité CI-SIS: Le type du défibrillateur est un élément obligatoire de
            l'organizer. </assert>
        <!-- Asservissement -->
        <assert
            test='cda:component/cda:observation[cda:templateId/@root = "1.2.250.1.213.1.1.3.1"]/cda:code/@code = "L0006"'>
            [E_DefribrillateurOrg_UFCV] Erreur de Conformité CI-SIS: Le type d'asservissement est l'un des éléments
            obligatoires constitutifs de l'organizer 'Défibrillateur'. </assert>
        <!-- Télésuivi -->
        <assert
            test='cda:component/cda:observation[cda:templateId/@root = "1.2.250.1.213.1.1.3.1"]/cda:code/@code = "L0007"'>
            Erreur de Conformité CI-SIS: Le télésuivi est un élément obligatoire de l'organizer. </assert>
        <!-- Télésuivi activé -->
        <assert
            test='cda:component/cda:observation[cda:templateId/@root = "1.2.250.1.213.1.1.3.1"]/cda:code/@code = "L0008"'>
            [E_DefribrillateurOrg_UFCV] Erreur de Conformité CI-SIS: L'activation du télésuivi est un élément obligatoire de
            l'organizer. </assert>
        ...
        <assert
            ...
            [E_DefribrillateurOrg_UFCV] Erreur de Conformité CI-SIS: Le stade NYHA est un élément obligatoire de l'organizer. </assert>
        <!-- FEVG -->
        <assert
            test='cda:component/cda:observation[cda:templateId/@root = "1.2.250.1.213.1.1.3.1"]/cda:code/@code = "L0010"'>
            [E_DefribrillateurOrg_UFCV] Erreur de Conformité CI-SIS: La FEVG est l'un des éléments obligatoires constitutifs
        ...
        <assert
            ...
            [E_DefribrillateurOrg_UFCV] Erreur de Conformité CI-SIS: la date des dernières mesures est un élément obligatoire
            de l'organizer. </assert>
        ...
        <assert
            ...
            [E_DefribrillateurOrg_UFCV] Erreur de Conformité CI-SIS: le mode programmé est un élément obligatoire de
            l'organizer. </assert>
        <!-- Tension Dernière Mesure -->
        <assert
            test='cda:component/cda:observation[cda:templateId/@root = "1.2.250.1.213.1.1.3.1"]/cda:code/@code = "L0014"'>
            [E_DefribrillateurOrg_UFCV] Erreur de Conformité CI-SIS: Tension est un élément obligatoire de l'organizer. </assert>
        ...
        <assert
            ...
            [E_DefribrillateurOrg_UFCV] Erreur de Conformité CI-SIS: Impédance est un élément obligatoire de l'organizer. </assert>
        ...
        <assert
            ...
            [E_DefribrillateurOrg_UFCV] Erreur de Conformité CI-SIS: Temps de charge est un élément obligatoire de
            l'organizer. </assert>
    </rule>
</pattern>
