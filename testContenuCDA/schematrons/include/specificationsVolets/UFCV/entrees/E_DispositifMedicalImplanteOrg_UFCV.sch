...
<!--                  -=<<o#%@O[ E_DispositifMédicalImplanteOrg_UFCV.sch ]O@%#o>>=-
...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="E_DispositifMédicalImplanteOrg_UFCV">
    ...
    <rule context='*[cda:templateId/@root = "1.2.250.1.213.1.1.3.2"]'>
        ...
        <assert test='.//cda:templateId[@root = "1.2.250.1.213.1.1.3.1"]'>
            [E_DispositifMédicalImplanteOrg_UFCV] Erreur de Conformité PCC: L'organizer doit au moins contenir une entrée 'Observation Dispositifs
            Médicaux'</assert>
        ...
        <assert
            ...
            [E_DispositifMédicalImplanteOrg_UFCV] Erreur de Conformité CI-SIS: La date d'implantation est un élément obligtoire de
            l'organizer. </assert>
        <!-- Dispositif implanté -->
        <assert
            test='
                ...
                /cda:code/@code = "L0056"'>
            [E_DispositifMédicalImplanteOrg_UFCV] Erreur de Conformité CI-SIS: 'Dispositif implanté' est un élément obligtoire. </assert>
