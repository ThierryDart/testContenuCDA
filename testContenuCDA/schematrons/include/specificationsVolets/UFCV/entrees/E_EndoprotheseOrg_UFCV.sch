...
<!--                  -=<<o#%@O[ E_EndoprotheseOrg_UFCV.sch ]O@%#o>>=-
...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="E_EndoprotheseOrg_UFCV">
    ...
    <rule
        ...
        <assert test='cda:code[@code = "D0001-12"]'>
            [E_EndoprotheseOrg_UFCV] Erreur de Conformité CI-SIS: Le code de l'organizer 'Endoprothèse' doit être D0001-11 pris dans le vocabulaire TA_PRC
            (1.2.250.1.213.1.1.4.2)</assert>

        <assert test='cda:code[@codeSystem = "1.2.250.1.213.1.1.4.2"]'>
            [E_EndoprotheseOrg_UFCV] Erreur de Conformité CI-SIS: L'élément 'codeSystem' de l'organizer 'Endoprothèse' doit être codé dans dans le
        ...
        <assert test='.//cda:templateId[@root = "1.2.250.1.213.1.1.3.1"]'>
            [E_EndoprotheseOrg_UFCV] Erreur de Conformité CI-SIS : L'organizer 'Endoprothèse' doit au moins contenir une entrée 'Observation
        ...
        <assert
            ...
            [E_EndoprotheseOrg_UFCV] Erreur de Conformité CI-SIS: La date d'implantation du matériel est un élément
        ...
        <assert
            ...
            [E_EndoprotheseOrg_UFCV] Erreur de Conformité CI-SIS: Le 'Type de matériel implanté' est un élément obligatoire
            de l'organizer. </assert>

        <!-- Nom de l'implant -->
        <assert
            test='cda:component/cda:observation[cda:templateId/@root = "1.2.250.1.213.1.1.3.1"]/cda:code/@code = "L0039"'>
            [E_EndoprotheseOrg_UFCV] Erreur de Conformité CI-SIS: Le 'Nom de l'mplant' de l'implant est un élément
            obligatoire de l'organizer. </assert>
        ...
        <assert
            ...
            [E_EndoprotheseOrg_UFCV] Erreur de Conformité CI-SIS: La Localisation de l'implant est un élément obligatoire
            de l'organizer. </assert>

        <!-- Modèle de l'implant -->
        <assert
            test='cda:component/cda:observation[cda:templateId/@root = "1.2.250.1.213.1.1.3.1"]/cda:code/@code = "L0051"'>
            [E_EndoprotheseOrg_UFCV] Erreur de Conformité CI-SIS: Le modèle de l'implant est l'un des éléments obligatoires
