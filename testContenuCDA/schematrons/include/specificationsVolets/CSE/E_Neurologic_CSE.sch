...
<!--                  -=<<o#%@O[ E_Neurologic_CSE.sch ]O@%#o>>=-
    ...
    15/05/18 : NMA : MAJ par rapport à la maj du volet par APE
    
-->


<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="E_Neurologic_CSE">
    ...
    <rule context='*[cda:templateId/@root="1.3.6.1.4.1.19376.1.5.3.1.1.9.35"]'>
        ...
        <assert test='not(/cda:ClinicalDocument/cda:templateId[@root="1.2.250.1.213.1.1.1.5.3"] or /cda:ClinicalDocument/cda:templateId[@root="1.2.250.1.213.1.1.1.5.2"]) or
            ...
            [E_Neurologic_CSE.sch] Erreur de Conformité volet CSE: L'absence ou la présence de Spina Bifida doit obligatoirement être mentionnée à partir du booléen observation/@negationInd
        </assert> 
        ...
        <assert test='not(/cda:ClinicalDocument/cda:templateId[@root="1.2.250.1.213.1.1.1.5.3"] or /cda:ClinicalDocument/cda:templateId[@root="1.2.250.1.213.1.1.1.5.2"]) or
            ...
            [E_Neurologic_CSE.sch] Erreur de Conformité volet CSE: L'absence ou la présence d'Infirmité motrice cérébrale doit obligatoirement être mentionnée à partir du booléen observation/@negationInd
        </assert>
        ...
        <assert test='not(/cda:ClinicalDocument/cda:templateId[@root="1.2.250.1.213.1.1.1.5.1"]) or
            ...
            [E_Neurologic_CSE.sch] Erreur de Conformité volet CSE: L'absence ou la présence d'anomalie du tube neural doit obligatoirement être mentionnée à partir du booléen observation/@negationInd
        </assert>
        
        <!-- Observation: Hydrocéphalie CS8 seulement -->
        <assert test='not(/cda:ClinicalDocument/cda:templateId[@root="1.2.250.1.213.1.1.1.5.1"]) or
            .//cda:entry/cda:observation[@negationInd]/cda:value/@code="D4-91300"'>
            [E_Neurologic_CSE.sch] Erreur de Conformité volet CSE: L'absence ou la présence d'hydrocéphalie doit obligatoirement être mentionnée à partir du booléen observation/@negationInd
        </assert>

<!--        <!-\- Observation: Fente labio-palatine -\->
        <assert test='.//cda:entry/cda:observation[@negationInd]/cda:value/@code="D4-51450"'>
            [E_Neurologic_CSE.sch] Erreur de Conformité volet CSE: L'absence ou la présence de Fente labio-palatine doit obligatoirement être mentionnée à partir du booléen observation/@negationInd
        </assert>       
 
        <!-\- Observation: Syndrome polymalformatif -\->
        <assert test='.//cda:entry/cda:observation[@negationInd]/cda:value/@code="D4-0100"'>
            [E_Neurologic_CSE.sch] Erreur de Conformité volet CSE: L'absence ou la présence de Syndrome polymalformatif doit obligatoirement être mentionnée à partir du booléen observation/@negationInd
        </assert>-->
        
        <!-- Observation: autre pathologie CS9 et CS24 seulement -->
        <assert test='not(/cda:ClinicalDocument/cda:templateId[@root="1.2.250.1.213.1.1.1.5.3"] or /cda:ClinicalDocument/cda:templateId[@root="1.2.250.1.213.1.1.1.5.2"]) or
            .//cda:entry/cda:observation[@negationInd]/cda:value/@code="GEN-097"'>
            [E_Neurologic_CSE.sch] Erreur de Conformité volet CSE: L'absence ou la présence d'une autre affection du système nerveux
        ...
        <!--<report test='(.//cda:entry/cda:observation[@negationInd="false"]/cda:value/@code="D4-90000") and 
            ...
            [E_Neurologic_CSE.sch] Erreur de Conformité volet CSE: Dans le cas d'une autre pathologie, préciser laquelle 
        </report>
        <report test='(.//cda:entry/cda:observation[@negationInd="true"]/cda:value/@code="D4-90000") and 
            (.//cda:entry/cda:observation[cda:value/@code="D4-90000"]/cda:entryRelationship/cda:act/cda:text!="")'> 
            [E_Neurologic_CSE.sch] Alerte: Dans le cas d'une autre affection du système signalée, 
