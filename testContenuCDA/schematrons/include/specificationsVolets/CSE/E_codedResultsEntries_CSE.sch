<?xml version="1.0" encoding="UTF-8"?>
    ...
    <!--                  -=<<o#%@O[ E_codedResultsEntries_CSE.sch ]O@%#o>>=-
...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="E_codedResultsEntries_CSE">
    ...
    <rule context="*[cda:templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.3.28']">
        ...
        <assert
            ...
            [E_codedResultsEntries_CSE.sch] Erreur de Conformité volet CS8: L'absence ou la présence d'échographie Morphologique doit être indiquée
        </assert>
        
        <assert
            test="cda:entry/cda:procedure/cda:code[@code ='P5-B005F']">
            [E_codedResultsEntries_CSE.sch] Erreur de Conformité volet CS8: L'absence ou la présence de mesure de la clarté nucale doit être indiquée
        </assert>
        ...
        <assert
            ...
            [E_codedResultsEntries_CSE.sch] Erreur de Conformité volet CS8: Le nombre total d'échographies doit être indiqué
        </assert>
        
        <assert
            test="cda:entry/cda:observation/cda:code[@code ='5196-1']">
            [E_codedResultsEntries_CSE.sch] Erreur de Conformité volet CS8: La recherche d'antigène HBs doit être indiquée
        </assert>
        
        <assert
            test="cda:entry/cda:observation[cda:code/@code ='5196-1']/cda:subject/cda:relatedSubject/cda:code/@code='MTH'">
            [E_codedResultsEntries_CSE.sch] Erreur de Conformité volet CS8: La recherche d'antigène HBs doit être attribuée à la mère par une entité "subject"
        </assert>       
