...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="E_eyes_CSE">
    ...
    <rule context='*[cda:templateId/@root="1.3.6.1.4.1.19376.1.5.3.1.1.9.19"]'>
        ...
        <assert test='.//cda:entry/cda:observation[@negationInd]/cda:value/@code="MED-187"'> 
            ...
            [E_eyes_CSE.sch] Erreur de Conformité volet CSE: L'absence ou la présence d'un examen optique normal doit obligatoirement être mentionnée à partir du booléen observation/@negationInd
        </assert>
    </rule>
</pattern>
