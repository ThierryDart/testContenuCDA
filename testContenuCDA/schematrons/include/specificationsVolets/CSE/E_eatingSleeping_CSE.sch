...
<!--                  -=<<o#%@O[ E_eatingSleeping_CSE.sch ]O@%#o>>=-
    ...
    11/10/17 : NMA : Ajout du nom du schématron dans les messages d'erreur
    22/11/17 : NMA : Mise à jour des codes TA_CS ==> TA_ASIP
    
    
-->

<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="E_eatingSleeping_CSE">
    ...
    <rule context='*[cda:templateId/@root="1.3.6.1.4.1.19376.1.7.3.1.1.13.5"]'>
        ...
        <assert test='.//cda:entry/cda:observation/cda:code/@code="D9-74000"'>
            [E_eatingSleeping_CSE.sch] Erreur de Conformité volet CSE: La mention de l'élément "Troubles du sommeil" est obligatoire
        </assert>
        <assert test='.//cda:entry/cda:observation[cda:code/@code="D9-74000"]/cda:value/@value'>
            [E_eatingSleeping_CSE.sch] Erreur de Conformité volet CSE: Le résultat de l'observation doit être reporté (pas de Nullflavor) 
        </assert>
        
        <!-- Troubles de l'alimentation -->
        <assert test='.//cda:entry/cda:observation/cda:code/@code="D9-13000"'>
            [E_eatingSleeping_CSE.sch]  Erreur de Conformité volet CSE: La mention de l'élément "Troubles de l'alimentation" est obligatoire
        </assert>
        ...
        <assert test='not(/cda:ClinicalDocument/cda:templateId[@root="1.2.250.1.213.1.1.1.5.3"]) or (.//cda:entry/cda:observation/cda:code/@code="D5-00300")'>
            [E_eatingSleeping_CSE.sch] Erreur de Conformité volet CSE: La mention de l'élément "Allergie alimentaire" est obligatoire
        </assert>
...
<!--        <!-\-  Allaitement au sein -\->
        <assert test='.//cda:entry/cda:observation/cda:code/@code="F-8A040"'>
            [E_eatingSleeping_CSE.sch]  Erreur de Conformité volet CSE: La mention de l'élément "Allaitement au sein" est obligatoire
        </assert>
        ...
        <assert test='.//cda:entry/cda:observation/cda:code/@code="MED-203"'>
            [E_eatingSleeping_CSE.sch]  Erreur de Conformité volet CSE: La mention de l'élément "Durée de l'allaitement au sein" est obligatoire
        </assert>
        ...
        <assert test='.//cda:entry/cda:observation/cda:code/@code="MED-204"'>
            [E_eatingSleeping_CSE.sch] Erreur de Conformité volet CSE: La mention de l'élément "Durée de l'alimentation exclusive au sein" est obligatoire
        </assert>
        ...
        <assert test='.//cda:entry/cda:observation[cda:code/@code="MED-204"]/cda:value/@xsi:type="PQ"'>
            [E_eatingSleeping_CSE.sch] Erreur de Conformité volet CSE: Le résultat de l'observation doit être de type 'PQ' 
        </assert>
-->
    </rule>
</pattern>
