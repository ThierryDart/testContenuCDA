...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="E_generalApp_CSE">
    ...
    <rule context='*[cda:templateId/@root="1.3.6.1.4.1.19376.1.5.3.1.1.9.16"]'>       
        ...
        <assert test='.//cda:entry/cda:observation[@negationInd]/cda:value/@code="D4-02214"'>
            [E_generalApp_CSE.sch] Erreur de Conformité volet CSE: L'absence ou la présence de trisomie 21 doit obligatoirement être mentionnée à partir du booléen observation/@negationInd
        </assert>
        
        <!-- Aberrations chromosomiques CS9, CS24 seulement -->
        <assert test='not(/cda:ClinicalDocument/cda:templateId[@root="1.2.250.1.213.1.1.1.5.3"] or /cda:ClinicalDocument/cda:templateId[@root="1.2.250.1.213.1.1.1.5.2"]) or
            .//cda:entry/cda:observation[@negationInd]/cda:value/@code="D4-02000"'>
            [E_generalApp_CSE.sch] Erreur de Conformité volet CSE: L'absence ou la présence d'une Aberration chromosomique
...
<!--    <report test='(.//cda:entry/cda:observation[@negationInd="false"]/cda:value/@code="D4-00000") and 
        ...
        [E_generalApp_CSE.sch] Erreur de Conformité volet CSE: Dans le cas d'une autre anomalie congénitale, préciser laquelle 
    </report>-->
        
    <report test='(.//cda:entry/cda:observation[@negationInd="true"]/cda:value/@code="D4-02000") and 
            (.//cda:entry/cda:observation[cda:value/@code="D4-02000"]/cda:entryRelationship/cda:act/cda:text!="")'> 
        [E_generalApp_CSE.sch] Erreur de Conformité volet CSE: Dans le cas d'une autre affection du système signalée, 
        ...
        <assert test='not(/cda:ClinicalDocument/cda:templateId[@root="1.2.250.1.213.1.1.1.5.3"] or /cda:ClinicalDocument/cda:templateId[@root="1.2.250.1.213.1.1.1.5.2"]) or
            ...
            [E_generalApp_CSE.sch] Erreur de Conformité volet CSE: L'absence ou la présence d'une autre pathologie doit obligatoirement être mentionnée à partir du booléen observation/@negationInd
        </assert>
        
        <report test='(.//cda:entry/cda:observation[@negationInd="false"]/cda:value/@code="GEN-097") and 
            (.//cda:entry/cda:observation[cda:value/@code="GEN-097"]/cda:entryRelationship/cda:act/cda:text="")'>
            [E_generalApp_CSE.sch] Erreur: Dans le cas d'une autre pathologie, préciser laquelle 
        </report>
        <report test='(.//cda:entry/cda:observation[@negationInd="true"]/cda:value/@code="GEN-097") and 
            (.//cda:entry/cda:observation[cda:value/@code="GEN-097"]/cda:entryRelationship/cda:act/cda:text!="")'> 
            [E_generalApp_CSE.sch] Erreur de Conformité volet CSE: Dans le cas d'une autre affection du système signalée, 
            le booléen cda:observation/@negationInd doit être fixé à la valeur "false" 
            sinon l'élément cda:entry/cda:observation/cda:entryRelationship/cda:act/cda:text doit être vide
