...
<!-- 
    ...
    Historique :
        08/03/2018 : NMA : Création
-->
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="JDV_AntecedentsObstetricaux_CSE" is-a="dansJeuDeValeurs">
    <p></p>
    <param name="path_jdv" value="$jdv_AntecedentsObstetricaux_CSE"/>
