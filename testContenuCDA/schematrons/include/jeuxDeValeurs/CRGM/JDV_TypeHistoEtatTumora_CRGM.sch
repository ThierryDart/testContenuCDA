...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="JDV_TypeHistoEtatTumora_CRGM" is-a="dansJeuDeValeurs">
    <param name="path_jdv" value="$jdv_CRGM_TypeHistoEtatTumora"/>
    <param name="vue_elt"
