...
<!--                  -=<<o#%@O[ ER_problemStatusObservation_int.sch ]O@%#o>>=-
    ...
    22/06/17 : NMA : Ajout de contraintes internationales et du test sur le nombre de templateId
    
-->

<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="ER_problemStatusObservation_int">
