...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="E_vitalSignsOrganizer_fr">
    ...
    <rule context="*[cda:templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.4.13.1']">
        ...
        <assert test="cda:code[@code='F-03400' and (@displayName='Signes Vitaux' or @displayName='signes vitaux' or @displayName='Signes vitaux') and @codeSystem='1.2.250.1.213.2.12' and @codeSystemName='SNOMED 3.5']">
