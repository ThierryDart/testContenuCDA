...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="E_specimenCollection_int">
    ...
    <rule context='*[cda:templateId/@root="1.3.6.1.4.1.19376.1.3.1.2"]'>
        ...
        <!--<assert test="not(cda:code) or (cda:code and cda:code[@code='33882-2'])">
            [E_specimenCollection_int.sch] Erreur de conformité PaLM : L'élément code doit contenir un attribut @code fixé à la valeur '33882-2', qui est le code LOINC de specimen collection s'il est présent
        </assert>-->
