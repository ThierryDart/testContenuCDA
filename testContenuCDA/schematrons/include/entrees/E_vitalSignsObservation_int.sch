...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="E_vitalSignsObservation_int.sch">
    ...
    <rule context='*[cda:templateId/@root="1.3.6.1.4.1.19376.1.5.3.1.4.13.2"]'>
        ...
        <!-- La suite permet de tester les code imposés par IHE PCC et l'élément value-->
...
<!--        <!-\- Type PQ des données Vital Signs -\->
        ...
        <!-- Poids -->
        <assert test='not(cda:code[@code="29463-7"]) or
            (cda:code[@code="29463-7"] and
        ...
        <assert test='not(cda:code[@code="2708-6"]) or
            (cda:code[@code="2708-6"] and
            cda:value[@unit="%"])'>
        ...
        <!-- APGAR à 1mn -->
        <assert test='not(cda:code[@code="9272-6"]) or
            (cda:code[@code="9272-6"] and
            cda:value[@xsi:type="INT"])'>
            [E_vitalSignsObservation_int.sch] Erreur de conformité PCC : l'APGAR à 1mn est un nombre entier
        </assert>        
        <!-- APGAR à 5mn -->
        <assert test='not(cda:code[@code="9274-2"]) or
            (cda:code[@code="9274-2"] and
            cda:value[@xsi:type="INT"])'>
            [E_vitalSignsObservation_int.sch] Erreur de conformité PCC : l'APGAR à 5mn est un nombre entier
        </assert> 
        <!-- IMC -->
        <assert test='not(cda:code[@code="39156-5"]) or
            (cda:code[@code="39156-5"] and
            cda:value[@unit="kg/m2"])'>
