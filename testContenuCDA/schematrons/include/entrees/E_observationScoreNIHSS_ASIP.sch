...
<!--                 
    ...
    Teste la conformité de l'observation score NIHSS (1.2.250.1.213.1.1.3.6), créée par l'ASIP Santé
    Au 18/08/2017, utilisée dans le volet AVX_AUNV
...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="E_observationScoreNIHSS_ASIP">
    <title>ASIP</title>
    <rule context='*[cda:templateId/@root="1.2.250.1.213.1.1.3.6"]'>
        ...
        <assert
            ...
            [E_observationScoreNIHSS_ASIP.sch] Erreur de conformité CI-SIS (ASIP Santé) : Dans l'observation score NIHSS, les attributs @classCode, @moodCode et @negationInd de l'élément observation sont fixés resectivement aux valeurs 'OBS', 'EVN' et 'false'</assert>
