...
<!-- 
    E_ACPimageIllustrative_int.sch :
    Contenu :
    ...
    Historique :
        ...
        30/10/17 : NMA : Changement du nom du schématron
-->
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="E_ACPimageIllustrative_int">
    ...
    <rule context="*[cda:templateId/@root = $templateObservationMedia]">
        ...
        <assert test="../cda:observationMedia[@classCode = 'OBS' and @moodCode = 'EVN' and @ID]"> 
            [E_ACPimageIllustrative_int] Erreur de Conformité CI-SIS : 
