...
<!--                  -=<<o#%@O[ VitalSignsObservation20131024.sch ]O@%#o>>=-
    ...
    aux spécifications de Modèles de contenu CDA

    
    Historique :
    20/06/2017 : LBE : Création
    29/11/17 : NMA : Mise à jour du test sur le nombre d'id car la bonne cardinalité est 0..1 et non 1..1
-->


<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="E_vtalSignsObservation_fr">
