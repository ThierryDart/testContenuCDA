...
<!-- Schématron Section cadre de la proposition thérapeutique
    
     Teste la conformité de la section note de progression ANS (1.2.250.1.213.1.1.2.45) créée par l'ANS
...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="S_cadrePropositionTherapeutique_ANS">
    <title>Section cadre Proposition Therapeutique ANS </title>
