...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="S_procedureCarePlan">
    ...
    <rule context="*[cda:templateId/@root=&quot;1.3.6.1.4.1.19376.1.5.3.1.1.9.40&quot;]"> 
        ...
        <assert test="../cda:section"> 
            [S_ProcedureCarePlan] Erreur de conformité PCC : 'Coded Care Plan' ne peut être utilisé que comme section.</assert>
        ...
        <assert test="cda:templateId[@root=&quot;1.3.6.1.4.1.19376.1.5.3.1.3.31&quot;]"> 
            [S_ProcedureCarePlan] Erreur de conformité PCC : Le templateId parent de la section 'Procedure Care Plan' (1.3.6.1.4.1.19376.1.5.3.1.1.9.40) doit être présent</assert>
        
        <!-- Vérifier le code de la section -->
        <assert test="cda:code[@code = &quot;18776-5&quot;]"> 
            [S_ProcedureCarePlan] Erreur de conformité PCC : Le code de la section 'Procedure Care Plan' doit être '18776-5'</assert>
