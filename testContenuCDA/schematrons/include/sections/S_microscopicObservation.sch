...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="S_microscopicObservation">
    ...
    <rule context="*[cda:templateId/@root='1.3.6.1.4.1.19376.1.8.1.2.4']">
        ...
        <assert test='cda:code[@code = "22635-7"]'>
            [S_microscopicObservation.sch] Erreur de Conformité APSR : Le code de la section "Microscopic Observation" doit être 22635-7 </assert>
        ...
        <assert test="cda:text">
            [S_microscopicObservation.sch] Erreur de conformité APSR : La section "Microscopic Observation" doit contenir un élément text"</assert>
        <assert test="cda:title">
            [S_microscopicObservation.sch] Erreur de conformité APSR : La section "Microscopic Observation" doit contenir un élément title"</assert>
