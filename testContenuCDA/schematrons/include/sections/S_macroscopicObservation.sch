...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="S_macroscopicObservation">
    ...
    <rule context="*[cda:templateId/@root='1.3.6.1.4.1.19376.1.8.1.2.3']">
        ...
        <assert test='cda:code[@code = "22634-0"]'>
            [S_macroscopicObservation.sch] Erreur de Conformité APSR : Le code de la section "Macroscopic Observation" doit être 22634-0 </assert>
        ...
        <assert test="cda:text">
            [S_macroscopicObservation.sch] Erreur de conformité APSR : La section "Macroscopic Observation" doit contenir un élément text"</assert>
        <assert test="cda:title">
            [S_macroscopicObservation.sch] Erreur de conformité APSR : La section "Macroscopic Observation" doit contenir un élément title"</assert>
