...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="S_encounterHistories">
    ...
    <rule context="*[cda:templateId/@root=&quot;1.3.6.1.4.1.19376.1.5.3.1.1.5.3.3&quot;]">
        ...
        <assert test="../cda:section"> 
            [S_encounterHistories] Erreur de Conformité PCC: 'Encounter Histories' ne peut être utilisé que comme section.</assert>
        
        <!-- Vérifier la présence des templateId parents. -->
        <assert test="cda:templateId[@root=&quot;2.16.840.1.113883.10.20.1.3&quot;]"> 
            [S_encounterHistories] Erreur de Conformité PCC: Les templateId des parents doivent être présents. </assert>
        ...
        <assert test="cda:code[@code = &quot;46240-8&quot;]"> 
            [S_encounterHistories] Erreur de Conformité PCC: Le code de la section 'Encounter Histories' doit être '46240-8'</assert>
        ...
        <assert test=".//cda:templateId[@root = &quot;1.3.6.1.4.1.19376.1.5.3.1.4.14&quot;]">
            [S_encounterHistories] Erreur de Conformité PCC: Une section "Encounter Histories" doit contenir des entrée de type "Encounters".</assert>
