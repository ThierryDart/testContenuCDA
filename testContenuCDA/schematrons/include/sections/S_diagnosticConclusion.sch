...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="S_diagnosticConclusion">
    ...
    <rule context="*[cda:templateId/@root='1.3.6.1.4.1.19376.1.8.1.2.5']">
        ...
        <assert test='cda:code[@code = "22637-3"]'>
            [S_diagnosticConclusion.sch] Erreur de Conformité APSR : Le code de la section "Diagnostic Conclusion" doit être 22637-3 </assert>
        ...
        <assert test="cda:text">
            [S_diagnosticConclusion.sch] Erreur de conformité APSR : La section "Diagnostic Conclusion" doit contenir un élément text"</assert>
        <assert test="cda:title">
            [S_diagnosticConclusion.sch] Erreur de conformité APSR : La section "Diagnostic Conclusion" doit contenir un élément title"</assert>
