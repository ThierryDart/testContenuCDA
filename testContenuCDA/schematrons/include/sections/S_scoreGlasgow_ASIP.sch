...
<!--                  Section score de Rankin ASIP Santé
   ...
   Teste la conformité de la section score de Glasgow (1.2.250.1.213.1.1.2.40) créée par l'ASIP Santé
...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="S_scoreGlasgow_ASIP">
    ...
    <rule context='*[cda:templateId/@root = "1.2.250.1.213.1.1.2.40"]'>
        ...
        <assert test='cda:code[@code = "35088-4"]'>
            [S_scoreGlasgow_ASIP.sch]  Erreur de Conformité CI-SIS (Section ASIP Santé) : Le code de la section Abdomen doit être 35088-4 </assert>
