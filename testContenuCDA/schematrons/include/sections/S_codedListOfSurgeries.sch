...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="S_codedListOfSurgeries">
    ...
    <rule context='*[cda:templateId/@root="1.3.6.1.4.1.19376.1.5.3.1.3.12"]'> 
        ...
        <assert test="cda:templateId[@root='1.3.6.1.4.1.19376.1.5.3.1.3.11']"> 
            [S_codedListOfSurgeries.sch] Erreur de conformité PCC : Le templateId parent de la section 'Coded List of Surgeries' (1.3.6.1.4.1.19376.1.5.3.1.3.11) doit être présent</assert>
        <!-- Vérifier la présence des templateId parents. -->
        <assert test="cda:templateId[@root='2.16.840.1.113883.10.20.1.12']"> 
            [S_codedListOfSurgeries.sch] Erreur de conformité PCC : Le templateId parent de la section 'Coded List of Surgeries' (2.16.840.1.113883.10.20.1.12) doit être présent</assert>
