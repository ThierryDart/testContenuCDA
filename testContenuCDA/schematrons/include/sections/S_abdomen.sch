...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="S_abdomen">
    ...
    <rule context='*[cda:templateId/@root = "1.3.6.1.4.1.19376.1.5.3.1.1.9.31"]'>
        ...
        <assert test="$count_templateId = 1"> [S_abdomen.sch] Erreur de Conformité volet PCC: La
            section abdomen ne doit contenir qu'un seul templateId (cardinalité [1..1]) </assert>
        <!-- Verifier que le templateId est utilisé pour une section -->
        <assert test="../cda:section"> [S_abdomen.sch] Erreur de Conformité volet PCC: Cet élément
            ne peut être utilisé que comme section. </assert>
        <!-- Vérifier le code de la section -->
        <assert test='cda:code[@code = "10191-5"]'> S_abdomen.sch] Erreur de Conformité volet PCC:
            Le code de la section Abdomen doit être 10191-5 </assert>
        <assert test='cda:code[@codeSystem = "2.16.840.1.113883.6.1"]'> S_abdomen.sch] Erreur de
            Conformité volet PCC: L'élément 'codeSystem' doit être codé à partir de la nomenclature
            LOINC (2.16.840.1.113883.6.1). </assert>
