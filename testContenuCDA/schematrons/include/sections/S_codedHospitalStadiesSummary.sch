...
<!--                  -=<<o#%@O[Coded Hospital Stadies Summary Section ]O@%#o>>=-
...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="S_CodedHospitalStadiesSummary">
    
    
    <title>IHE PCC v3.0 Coded Hospital Stadies Summary Section</title>
