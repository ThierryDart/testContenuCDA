...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="S_clinicalInformation">
    ...
    <rule context="*[cda:templateId/@root='1.3.6.1.4.1.19376.1.8.1.2.1']">
        ...
        <assert test='cda:code[@code = "22636-5"]'>
            [S_clinicalInformation.sch] Erreur de Conformité APSR : Le code de la section "Clinical Information" doit être 22636-5 </assert>
        ...
        <assert test="cda:text">
            [S_clinicalInformation.sch] Erreur de conformité APSR : La section "Clinical Information" doit contenir un élément text"</assert>
        <assert test="cda:title">
            [S_clinicalInformation.sch] Erreur de conformité APSR : La section "Clinical Information" doit contenir un élément title"</assert>
