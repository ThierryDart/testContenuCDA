...
<!--                  Section statut du dossier présenté en RCP ANS
    
   Teste la conformité de la section statut du dossier présenté en RCP (1.2.250.1.213.1.1.2.33) créée par l'ANS
...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="S_statutDossPresenteRCP_ANS">
    <title>ANS Section statut du dossier présenté en RCP</title>
