...
echo Verification du fichier %1.xml
@echo on
java -cp saxon9he.jar net.sf.saxon.Transform -s:..\..\%1.xml -xsl:..\profils\ModelesDeContenuCDA.xsl -o:..\rapports\%1_verif_Modeles_IHE_FR.xml 
@echo off
echo.
echo Rapport de Verification : ..\rapports\%1_verif_Modeles_IHE_FR.xml
echo.
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
:: Partie à ne garder qu'en développement
...
echo Verification du fichier %1.xml
@echo on
java -cp saxon9he.jar net.sf.saxon.Transform -s:..\..\%1.xml -xsl:..\profils\ModelesASIP.xsl -o:..\rapports\%1_verif_Modeles_ASIP_FR.xml 
@echo off
echo.
echo Rapport de Verification : ..\rapports\%1_verif_Modeles_ASIP_FR.xml
echo.
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
:: Partie à ne garder qu'en développement
