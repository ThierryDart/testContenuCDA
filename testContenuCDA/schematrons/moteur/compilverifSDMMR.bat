...
@echo on
java -cp saxon9he.jar net.sf.saxon.Transform -s:..\..\%1.xml -xsl:..\profils\IHE.xsl -o:..\rapports\%1_verif_IHE.xml 
@echo off
echo.
echo Rapport de Verification : ..\rapports\%1_verif_IHE.xml
echo.
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
:: Partie à ne garder qu'en développement
...
echo 1) precompilation du schematron : collage des include
@echo on
java -cp saxon9he.jar net.sf.saxon.Transform -s:..\profils\ModelesDeContenuCDA.sch -xsl:iso_dsdl_include.xsl -o:colle.sch
@echo off
echo.
echo 2) precompilation du schematron : expansion des abstract
@echo on
...
@echo off
echo.
echo 3) compilation en xslt2 : produit \profils\ModelesDeContenuCDA.xsl
@echo on
java -cp saxon9he.jar net.sf.saxon.Transform -s:concret.sch -xsl:iso_svrl_for_xslt2.xsl -o:..\profils\ModelesDeContenuCDA.xsl 
@echo off
::
echo.
echo Verification du fichier %1.xml
@echo on
java -cp saxon9he.jar net.sf.saxon.Transform -s:..\..\%1.xml -xsl:..\profils\ModelesDeContenuCDA.xsl -o:..\rapports\%1_verif_ModelesDeContenuCDA.xml 
@echo off
echo.
echo Rapport de Verification : ..\rapports\%1_verif_ModelesDeContenuCDA.xml
echo.
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
:: Partie à ne garder qu'en développement
...
echo Verification du fichier %1.xml
@echo on
java -cp saxon9he.jar net.sf.saxon.Transform -s:..\..\%1.xml -xsl:..\profils\IHE_XDS-SD.xsl -o:..\rapports\%1_verif_IHE_XDS-SD.xml 
@echo off
echo.
echo Rapport de Verification : ..\rapports\%1_verif_IHE_XDS-SD.xml
echo.
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
:: Partie à ne garder qu'en développement
...
echo 1) precompilation du schematron : collage des include
@echo on
java -cp saxon9he.jar net.sf.saxon.Transform -s:..\profils\ModelesASIP.sch -xsl:iso_dsdl_include.xsl -o:colle.sch
@echo off
echo.
echo 2) precompilation du schematron : expansion des abstract
@echo on
...
@echo off
echo.
echo 3) compilation en xslt2 : produit \profils\ModelesASIP.xsl
@echo on
java -cp saxon9he.jar net.sf.saxon.Transform -s:concret.sch -xsl:iso_svrl_for_xslt2.xsl -o:..\profils\ModelesASIP.xsl 
@echo off
::
echo.
echo Verification du fichier %1.xml
@echo on
java -cp saxon9he.jar net.sf.saxon.Transform -s:..\..\%1.xml -xsl:..\profils\ModelesASIP.xsl -o:..\rapports\%1_verif_ModelesASIP.xml 
@echo off
echo.
echo Rapport de Verification : ..\rapports\%1_verif_ModelesASIP.xml
echo.
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
:: Partie à ne garder qu'en développement
