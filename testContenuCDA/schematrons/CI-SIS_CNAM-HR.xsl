...
<xsl:template match="/">
      ...
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                              title="Rapport de conformité du document aux spécifications du volet CNAM-HR"
                              schemaVersion="CI-SIS_CNAM-HR.sch">
         <xsl:attribute name="phase">HR</xsl:attribute>
   ...
   <!--SCHEMATRON PATTERNS-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Rapport de conformité du document aux spécifications du volet CNAM-HR</svrl:text>
...
<xsl:template match="cda:ClinicalDocument/cda:component/cda:structuredBody" priority="1000"
      ...
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="cda:component/cda:section/cda:templateId[@root='2.16.840.1.113883.10.20.1.8']"/>
         <xsl:otherwise>
