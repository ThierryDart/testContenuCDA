...
<!-- 
    ...
    Historique :
        ...
        23/08/17 : NMA : Suppression du schématron qui teste la psychomotricité (CSEPsychoMotEnt20110725.sch)
       14/03/18 : NMA : MAJ du pattern variables
                         
-->
<schema xmlns="http://purl.oclc.org/dsdl/schematron" defaultPhase="CS9-20121008"
    xmlns:cda="urn:hl7-org:v3" queryBinding="xslt2"
    xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" schemaVersion="CI-SIS_CSE_CS9.sch">
    <title>Rapport de conformité du document aux spécifications du volet Certificat de santé de l'enfant (modèle CS9)</title>
    ...
    <include href="include/specificationsVolets/CSE/S_CS9codedPhysicalExam.sch"/>
    <include href="include/specificationsVolets/CSE/S_carePlan_CSE.sch"/>  
    ...
    <!-- Inchangés -->
    <include href="../schematrons/include/specificationsVolets/CSE/E_CodedVitalSigns_CSE.sch"/>
    <include href="../schematrons/include/specificationsVolets/CSE/E_historyOfPastIllness_CSE.sch"/>
    <include href="../schematrons/include/specificationsVolets/CSE/E_musculo_CSE.sch"/>
    ...
    <include href="include/jeuxDeValeurs/CSE/JDV_typeGardeEnfant_CSE.sch"/>
    <include href="include/jeuxDeValeurs/CSE/JDV_typeGardePleinTemps_CSE.sch"/>
    ...
    <phase id="CS9-20121008">
        ...
        <active pattern="S_CS9codedPhysicalExam"/>
    ...
    <pattern id="variables">
        ...
        <rule context="cda:ClinicalDocument">
            <assert test="./cda:templateId[@root='1.2.250.1.213.1.1.1.5.2']"> 
                [CI-SIS_CertificatSanteCS9] Erreur de conformité CS9 :
            ...
            <assert test="cda:templateId[@root='1.2.250.1.213.1.1.1.5']"> 
                [CI-SIS_CertificatSanteCS9] Erreur: Le template parent "Certificat de Santé de l'Enfant" (1.2.250.1.213.1.1.1.5) doit être présent.
            </assert>
