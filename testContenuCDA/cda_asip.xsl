			...
			<body>
				...
				<table class="table_generale">
						<td>
							...
							<tr><xsl:call-template name="informant"/></tr>
						</td>
						<td>
							...
							<tr><xsl:call-template name="participant"/></tr>							
						</td>					
						<td>							
							<tr><xsl:call-template name="author"/></tr>
							<tr><xsl:call-template name="authenticator"/></tr>							
							<tr><xsl:call-template name="dataEnterer"/></tr>
						</td>
						<td>
							<tr><xsl:call-template name="documentGeneral"/></tr>
							<tr><xsl:call-template name="legalAuthenticator"/></tr>
							<tr><xsl:call-template name="custodian"/></tr>
							<tr><xsl:call-template name="informationRecipient"/></tr>
						</td>
				</table>
